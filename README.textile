...
Let's say that you have comma separated list of items stored inside article's "custom field":http://textpattern.net/wiki/index.php?title=custom_field. For example, list of "Nameless" video service's video IDs (@ID1, ID2, ID3, ID4@), and you want to embed each of those as a playable video.
...
bc. <txp:rah_repeat duplicates="1" value="foo, bar, bar, foo, bar, bar, foo, foobar">
	<txp:rah_repeat_value />
</txp:rah_repeat>
...
bc. <txp:rah_repeat value="b, a, c" sort="regular asc">
	<txp:rah_repeat_value />
</txp:rah_repeat>
